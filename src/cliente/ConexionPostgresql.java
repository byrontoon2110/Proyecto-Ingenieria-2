...
public class ConexionPostgresql {
    ...
    public ConexionPostgresql conectar() {
        try {
         ...
         String BaseDeDatos = "jdbc:postgresql://localhost:5454/CLIENTE?autoReconnect=true&relaxAutoCommit=true"; //crea una variable con la direccion el puerto y la instancia (express)
         conexionBD = DriverManager.getConnection(BaseDeDatos, "postgres","123");  // carga la conexion (usuario contraseña)
